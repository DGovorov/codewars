 ...
 * a positive integer k, if it exists, such as the sum of the digits of n taken to the successive
...
public class DigPow {
    ...
    public static long digPow(int n, int p) {
        ...
        List<Integer> digits = digitsOf(n);
    ...
    private static List<Integer> digitsOf(int n) {
